        ...
        <div className="bg-black/25 backdrop-blur-[2px] p-5 sm:p-8">
          ...
          <div className="rounded-3xl md:w-1/2 md:m-auto border border-white/30 bg-white/20 backdrop-blur-xl p-5 sm:p-7">
            ...
            <div>
              ...
              {/* Button */}
              <button type='submit' className="w-full cursor-pointer rounded-xl bg-linear-to-r from-green-600 to-emerald-500 py-3 font-semibold text-white shadow-lg transition hover:scale-[1.01]" disabled={isSubmitting}>
                    {isSubmitting ? (
